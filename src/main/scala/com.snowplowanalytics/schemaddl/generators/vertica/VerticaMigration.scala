...
import com.snowplowanalytics.schemaddl.generators.vertica.Ddl.Column
import com.snowplowanalytics.schemaddl.generators.vertica.VerticaDdlGenerator._
...
case class VerticaMigration(
  ...
  def toDdl(tableSchema: Option[String], varcharSize: Int) = VerticaMigration.toDdl(this, tableSchema, varcharSize)
}

object VerticaMigration {
  /**
